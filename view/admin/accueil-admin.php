<?php ob_start(); ?>
    ...
    <section id="section_accueil-admin">
        ...
        <div>
            ...
            <table>
                ...
                <?php foreach ($liensTypRub as list($idL, $lib, $nomR, $adrF, $lien)) : ?>
                    <tr>
                        ...
                        <form action="modif-lien.ctrl.php" method="POST" onsubmit="return sure()">
                            ...
                            <td style="display: none;"><input type="text" name="idLien" value="<?php if (isset($idL)) {
                                    echo $idL;
                                } ?>"/></td>
                    ...
                    <td><input type="text" name="nomRub" value="<?php //if(isset($nomR)) {echo $nomR;} ?>" /></td>-->
                            ...
                            <td><input type="text" name="adrOuFich" value="<?php if (isset($adrF)) {
                                    echo $adrF;
                                } ?>"/></td>

                            <td><input type="text" name="nomLien" value="<?php if (isset($lien)) {
                                    echo $lien;
                                } ?>"/></td>
                        ...
                        <td class="td-suppr"><a href="suppr-lien.ctrl.php?idLien=<?php echo $idL; ?>" class="btn btn-danger"
                ...
                <form action="ajout-lien.ctrl.php" method="POST" onsubmit="return sure()">
                  ...
                  <td><input type="text" name="nomRub" value="<?php //if(isset($nomRub)) {echo $nomRub;} ?>" required /></td>-->
                        ...
                        <td><input type="text" name="adrOuFich" value="<?php if (isset($adrOuFich)) {
                                echo $adrOuFich;
                            } ?>" required/></td>

                        <td><input type="text" name="nomLien" value="<?php if (isset($nomLien)) {
                                echo $nomLien;
                            } ?>" required/></td>
            ...
            <p>
                <a href="utilisateurs.ctrl.php">
                    <button class="btn btn-primary">Utilisateurs</button>
                </a>
                <a href="types_rubriques.ctrl.php">
