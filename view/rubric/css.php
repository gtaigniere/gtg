<?php ob_start(); ?>
    ...
    <section id="section_css">
        ...
        <h4>Texte</h4>
        <p class="css">font: Cette propriété permet de définir toutes les propriétés de font en même temps (font:15px/18px Calibri bold italic ; font:Arial, Cambria 100%/120% italic)<br>
        ...
        <h4>Alignement</h4>
        <p class="css">text-align : Alignement horizontal (left, right, center, justify)<br>
        ...
        <h4>Marges</h4>
        <p class="css">margin: Permet de définir la valeur des 4 marges (top - right - bottom - left)<br>
        ...
        <h4>Bordures</h4>
        <p class="css">border[-top, -left, -right, -bottom] : Bordure en général<br>
        ...
        <h4>Arrière plan</h4>
        <p class="css">background : Regroupe les 5 propriétés suivantes (background: rgb(120, 100, 214), #005500, blue)<br>
        ...
        <p class="css">position : Mode de positionnement (absolute : Positionnement absolu, mesuré à partir du bord de l'élément parent, peut défiler ; fixed : Positionnement absolu, mesuré à partir du bord de l'élément parent, reste fixe lors du défilement ; relative : Positionnement relatif mesuré à partir de la position de départ de l'élément proprement dit ; static : Pas de positionnement spécial, flux normal de l'élément (réglage par défaut))</p>

        <p>width : Largeur (min-width, max-width)<br>
            height : Hauteur(min-height, max-height)</p>

        <p>overflow : Passage d'élément au contenu trop important (visible : L'élément sera agrandi de manière à ce que son contenu soit complètement visible dans tous les cas ; hidden : L'élément sera coupé s'il dépasse les limites ; scroll : L'élément sera coupé s'il dépasse les limites. Le navigateur doit pourtant proposer des barres de défilement, un peu comme dans une fenêtre cadre incorporée ; auto : Le navigateur doit décider en cas de conflit, comment l'élément sera affiché. Proposer des barres de défilement est également permis)</p>
        <p>direction : Fixe le sens d’écriture (ltr : de gauche à droite ; rtl : de droite à gauche)</p>
        <p>float : Cours du texte (left : L'élément se trouve à gauche et sera entouré par la droite des éléments qui le suivent ; right : L'élément se trouve à droite et sera entouré par la gauche des éléments qui le suivent ; none : L'élément ne sera pas entouré (réglage normal)<br>
        ...
        <p>content : Permet de générer du contenu (content: '#';)</p>
        <p>z-index : Position de la couche en cas de superposition (auto, valeur entière(5, 100, …))</p>
        <p>visibility : Affichage ou non affichage avec réservation de place (hidden, visible, collapse)</p>
        <p>attr() : Pour récupérer la valeur d'un attribut afin de l'utiliser</p>

        <h4>Listes</h4>
        <p class="css">list-style: Permet de définir dans un seul format, les propriétés suivantes (list-style : georgian inside;)<br>
        ...
        <h4>Liens</h4>
        <p class="css zmargin_bottom">Type (a:link ; a:visited ; a:hover ; a:active)</p>
        <p class="css indent1fois zmargin_bottom">Exemple :</p>
        <p class="css indent2fois zmargin_bottom">a {text-decoration:none; color:#FF0000} ;</p>
        <p class="css indent2fois">a:hover {text-decoration:underline; color:red}</p>
        ...
        <h4>Animations</h4>
        <p class="css">transition : Regroupe les 4 propriétés suivantes ()<br>
        ...
        <h4>Boîtes</h4>
        <p class="css">box-shadow : Ombrage de boîte (décalage-x décalage-y rayons-de-flou-et-d-étalements couleur : 2px 2px 2px 1px rgba(0, 0, 0, 0.2);)<br>
            box-sizing : Définit la façon dont la hauteur et la largeur totale d'un élément est calculée (content-box, border-box)</p>

        <h4>Compteurs</h4>
        <p class="css">counter() : Renvoie une chaîne de caractères qui représente la valeur courante du compteur<br>
        ...
        <h3>Flexbox</h3>
        <p class="css">display : flex | inline-flex;<br>
        ...
        <h3>Media queries</h3>
        <p class="css zmargin_bottom">@media screen and (max-width: 800px)  {</p>
        <p class="css indent1fois zmargin_bottom">Indiquer les propriétés CSS ici</p>
        <p class="css">}</p>
        <p class="css zmargin_bottom">@media screen and (min-width: 1200px)  {</p>
        <p class="css indent1fois zmargin_bottom">Indiquer les propriétés CSS ici</p>
        <p class="css">}</p>
        <p class="css">Il est préférable de définir des points en rapport avec la taille d'écran en pixels à partir desquels on va modifier le CSS plutôt que de définir différents formats d'écran comme cela se faisait avant.</p>
        <p class="css"><a href="https://developer.mozilla.org/fr/docs/Web/CSS/Requ%C3%AAtes_m%C3%A9dia/Utiliser_les_Media_queries">Plus d'infos sur les Media queries</a></p>
        ...
        <h3>Variables</h3>
        <p class="css zmargin_bottom">Elles commencent toujours par "--".</p>
        <p class="css zmargin_bottom">"root" est plus spécifique que "html" donc il aura priorité.</p>
        <p class="css indent1fois zmargin_bottom">:root {</p>
        <p class="css indent2fois zmargin_bottom">--primary: red;</p>
        <p class="css indent1fois zmargin_bottom">}</p>
        <p class="css indent1fois zmargin_bottom">html {</p>
        <p class="css indent2fois zmargin_bottom">--primary: #0488CA</p>
        <p class="css indent1fois">}</p>
        <p class="css zmargin_bottom">Le sélecteur de classe est plus précis donc il l'emporte sur "root" et donc sur "html".</p>
        <p class="css indent1fois zmargin_bottom">.theme-vert {</p>
        <p class="css indent2fois zmargin_bottom">--primary: green;</p>
        <p class="css indent1fois">}</p>
        <p class="css zmargin_bottom">La seconde valeur de "background" est une valeur par défaut au cas où "--primary" ne serait pas définie.</p>
        <p class="css indent1fois zmargin_bottom">.topbar {</p>
        <p class="css indent2fois zmargin_bottom">color: #FFF;</p>
        <p class="css indent1fois">}</p>
